...
export default function LabHero() {
  return (
    <div>
      {/* Full-bleed image — no overlay, light bg reads cleanly without scrim */}
      ...
      <div className="lab-asset-frame mt-10 grid grid-cols-1 lg:grid-cols-3 divide-y lg:divide-y-0 lg:divide-x divide-black/8 overflow-hidden">
        {STATS.map((stat) => (
          <div key={stat.value} className="flex items-center gap-5 px-5 py-4 lg:px-6 lg:py-5 lg:flex-col lg:items-start lg:gap-1">
