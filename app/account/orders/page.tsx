          ...
          {orders.length > 0 && (
            <div className="grid grid-cols-3 gap-4 mb-8 mt-6">
              <div className="neo-box p-4 text-center">
                <p className="font-clinical text-2xl font-bold">
                  {orders.length}
                </p>
          ...
          {orders.length === 0 ? (
            <div className="neo-box p-12 text-center">
              ...
              <div className="border-t-2 border-current/10 pt-8 mt-8">
                <p className="font-clinical text-xs uppercase opacity-50 mb-4">
                  Start Shopping
                </p>
                                ...
                                {ORDER_STEPS.map((step, index) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      {/* Step Label */}
                                      <p
                                        className={`font-clinical text-xs mt-2 text-center ${
                                          isActive
                        ...
                        <div className="p-6 pt-0">
                          ...
                          <div className="mt-6 pt-4 border-t-2 border-current/10">
                            ...
                            <div className="space-y-2">
                              ...
                              {order.totalShipping &&
                                parseFloat(order.totalShipping.amount) ===
                                  0 && (
                                  <div className="flex justify-between font-clinical text-sm">
                                    <span className="opacity-70">Shipping</span>
          ...
          {orders.length > 0 && (
            <div className="mt-12 neo-box p-6 text-center">
              ...
              <p className="font-clinical text-sm opacity-70 mb-4">
                Our team is here to help with tracking, returns, or any other
                questions
              </p>
              <a
