      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16">
        ...
        <div className="mb-12">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-8">
            <div>
              <p className="font-clinical text-sm uppercase tracking-wider opacity-50 mb-2">Research & Results</p>
              <h1 className="text-4xl lg:text-5xl font-bold mb-2">Case Studies</h1>
              <p className="font-commentary text-xl lg:text-2xl">real athletes, measurable results</p>
            </div>
          ...
          <div className="flex-1 min-w-0">
            {activeAthlete ? (
              ...
              <div className="neo-box p-12 text-center">
                <p className="font-commentary text-xl opacity-50">Select an athlete to view their case study</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="mt-16 neo-box p-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="font-commentary text-lg opacity-70">Join hundreds of athletes improving their cognitive performance</p>
            </div>
