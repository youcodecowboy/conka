...
export function AppHero() {
  return (
    <>
      ...
      `}</style>
      <section
        className="relative flex min-h-[100svh] w-full flex-col text-white lg:min-h-[100svh] lg:flex-row lg:items-center px-[var(--premium-gutter-mobile)] lg:px-[var(--premium-gutter-desktop)] py-[clamp(2rem,6vw,4rem)]"
        ...
        <div className="relative z-[2] mx-auto flex w-full max-w-[var(--premium-max-width)] flex-1 flex-col gap-10 lg:flex-row lg:items-center lg:gap-12">
          ...
          <div className="hero-mount-right relative flex flex-1 justify-center lg:w-1/2 lg:justify-end">
            ...
            <img
              ...
              className="relative z-[1] h-auto w-[clamp(220px,70vw,320px)] lg:w-[clamp(260px,38vw,480px)]"
              style={{
