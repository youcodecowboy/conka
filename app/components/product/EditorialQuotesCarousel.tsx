...
function QuoteCard({ quote }: { quote: EditorialQuote }) {
  return (
    <div
      className="flex flex-col h-full min-h-[220px] bg-white p-[var(--premium-space-m)] text-black"
...
export default function EditorialQuotesCarousel({
  ...
  return (
    <>
      ...
      <div
        className="flex gap-[var(--premium-space-m)] overflow-x-auto overflow-y-hidden scroll-smooth snap-x snap-mandatory py-2 lg:hidden [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
