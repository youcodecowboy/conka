...
export default function ProductHero({
  ...
  const layoutWrapperClass = usePremium
    ? "premium-hero-layout"
    : "flex flex-col lg:flex-row gap-8 lg:gap-12";
  const leftColumnClass = usePremium
    ? "premium-hero-media order-1 lg:order-1"
    : "lg:w-[55%] order-1 lg:order-1 relative z-0";
  const rightColumnClass = usePremium
    ? "premium-hero-stack order-2 lg:order-2 relative z-10"
    : "lg:w-1/2 order-2 lg:order-2 relative z-10";
          ...
          <div className={rightColumnClass}>
            {usePremium ? (
              <div className={boxClass}>
                {/* Block 1: Title */}
                <div className={`p-4 md:p-6 ${headerBgClass}`}>
                ...
                {/* Block 2: Immediate proof (Step 1 in-hero) */}
