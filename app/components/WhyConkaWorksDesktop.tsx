      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        ...
        <div className="premium-card-soft premium-card-soft-stroke border-t-4 border-t-[#3a9f7e] p-6 md:p-8 flex flex-col items-center text-center md:min-h-[400px]">
          <div className="mb-6 h-24 md:h-32 flex items-center justify-center rounded-2xl bg-[var(--color-premium-bg-soft)] p-8">
            <Image src="/logos/InformedSportLogo.png" alt="Informed Sport certified" width={128} height={128} className="h-24 md:h-32 w-auto object-contain" />
          </div>
          <h3 className="premium-heading text-xl md:text-2xl font-bold mb-4" style={{ letterSpacing: "var(--letter-spacing-premium-title)" }}>
          ...
          <div className="flex flex-wrap justify-center gap-2" aria-hidden="true">
            <span className="px-3 py-1.5 rounded-full text-xs font-medium border border-[var(--color-premium-stroke)] bg-white text-[var(--text-on-light)] flex items-center gap-1.5"><CheckIcon /> Banned substance tested</span>
            <span className="px-3 py-1.5 rounded-full text-xs font-medium border border-[var(--color-premium-stroke)] bg-white text-[var(--text-on-light)] flex items-center gap-1.5"><CheckIcon /> Heavy metal tested</span>
            <span className="px-3 py-1.5 rounded-full text-xs font-medium border border-[var(--color-premium-stroke)] bg-white text-[var(--text-on-light)] flex items-center gap-1.5"><CheckIcon /> Batch verified</span>
          </div>
          <Link href="https://sport.wetestyoutrust.com/supplement-search/brand/conka" target="_blank" rel="noopener noreferrer" className="premium-body-sm text-[var(--color-ink)] font-medium hover:underline mt-auto pt-4">
            View Certificate →
          </Link>
        </div>
        ...
        <div className="premium-card-soft premium-card-soft-stroke p-6 md:p-8 flex flex-col items-center text-center md:min-h-[400px]">
          ...
          <div className="flex flex-wrap justify-center gap-2" aria-hidden="true">
            <span className="px-3 py-1.5 rounded-full text-xs font-medium border border-[var(--color-premium-stroke)] bg-white text-[var(--text-on-light)] flex items-center gap-1.5"><CheckIcon /> Clinical dosing</span>
            <span className="px-3 py-1.5 rounded-full text-xs font-medium border border-[var(--color-premium-stroke)] bg-white text-[var(--text-on-light)] flex items-center gap-1.5"><CheckIcon /> Peer-reviewed</span>
            <span className="px-3 py-1.5 rounded-full text-xs font-medium border border-[var(--color-premium-stroke)] bg-white text-[var(--text-on-light)] flex items-center gap-1.5"><CheckIcon /> University-backed</span>
          </div>
          <Link href="/research" className="premium-body-sm text-[var(--color-ink)] font-medium hover:underline mt-auto pt-4">View Research →</Link>
        </div>

        {/* Pillar 3 */}
        <div className="premium-card-soft premium-card-soft-stroke p-6 md:p-8 flex flex-col items-center text-center md:min-h-[400px]">
          <div className="mb-6 h-24 md:h-32 flex items-center justify-center rounded-2xl bg-[var(--color-premium-bg-soft)] p-8">
            <Image src="/logos/MadeInBritain.png" alt="Made in Britain" width={128} height={64} className="h-24 md:h-32 w-auto object-contain" />
          </div>
          <h3 className="premium-heading text-xl md:text-2xl font-bold mb-4" style={{ letterSpacing: "var(--letter-spacing-premium-title)" }}>
          ...
          <div className="flex flex-wrap justify-center gap-2" aria-hidden="true">
            <span className="px-3 py-1.5 rounded-full text-xs font-medium border border-[var(--color-premium-stroke)] bg-white text-[var(--text-on-light)] flex items-center gap-1.5"><CheckIcon /> GMP certified</span>
            <span className="px-3 py-1.5 rounded-full text-xs font-medium border border-[var(--color-premium-stroke)] bg-white text-[var(--text-on-light)] flex items-center gap-1.5"><CheckIcon /> Batch tested</span>
            <span className="px-3 py-1.5 rounded-full text-xs font-medium border border-[var(--color-premium-stroke)] bg-white text-[var(--text-on-light)] flex items-center gap-1.5"><CheckIcon /> Made in England</span>
          </div>
