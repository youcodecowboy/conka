...
export default function PillarCard({
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2">
            <span
              className="text-xl font-bold font-clinical"
      ...
      {isExpanded && (
        <div
          className={`border-t border-black/6 ${isMobile ? "p-4 space-y-5" : "p-6 space-y-6"}`}
        >
          {/* What it does */}
          <div>
          ...
          <div>
            ...
            >
              {pillar.keyStats.map((stat, idx) => (
                <div
                  key={idx}
                  className="p-3 rounded-[var(--brand-radius-container)] border border-black/6 text-center"
                ...
                >
                  ...
                  <a
                    ...
                    className="brand-caption hover:underline mt-2 block text-xs min-h-[44px] flex items-center justify-center"
                    style={{ color: "var(--brand-accent)" }}
                  >
                    PMID: {stat.pmid}
                  </a>
          ...
          <div>
            ...
            <div className="space-y-2">
              {pillar.ingredients.map((ingredient, idx) => (
                <div
                  key={idx}
                  className="flex items-center gap-3 p-3 rounded-[var(--brand-radius-container)] border border-black/6"
                  style={{ backgroundColor: "var(--brand-tint)" }}
                >
                  <span
                    className="w-2 h-2 rounded-full flex-shrink-0"
