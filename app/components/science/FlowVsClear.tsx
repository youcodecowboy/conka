  ...
  return (
    <div>
      ...
      <div className="mb-8 lg:mb-10">
        ...
        <p className="brand-body text-base lg:text-lg mt-2 text-black/60">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 mb-6">
        {formulaComparison.map((formula) => {
          ...
          return (
            <div
              key={formula.formula}
              className="brand-card-bordered p-5 lg:p-8"
            >
              ...
              {/* Description */}
              <p className="brand-body text-sm lg:text-base text-black/80">
                {formula.description}
              </p>
            </div>
          );
      ...
      >
        <p className="brand-body text-base lg:text-lg text-black/80">
