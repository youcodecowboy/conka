        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="premium-card-soft premium-card-soft-stroke p-6 md:p-8 flex flex-col items-center text-center min-h-0 md:min-h-[400px]">
            <div className="mb-6 h-24 md:h-32 flex items-center justify-center">
              {/* TODO: Replace with <Image src="/informed-sport-logo.png" ... /> when asset is in /public */}
              <div
                className="h-24 md:h-32 flex items-center justify-center rounded-lg border border-[var(--color-premium-stroke)] bg-[var(--color-premium-bg-soft)] px-6"
                aria-hidden
              >
                <span className="premium-body-sm font-semibold text-[var(--text-on-light-muted)]">
                  Informed Sport
                </span>
              </div>
            </div>
            ...
            <Link
              href="/informed-sport-certificate"
