...
const PROTOCOL_STRUGGLES = [
  {
    ...
    description: "Combining both formulas creates a synergistic effect that sustains peak cognitive performance longer than either alone.",
  ...
  },
  {
    ...
    description: "Adaptogens from Conka Flow combined with cognitive enhancers from Conka Clarity create a balanced stress response system.",
  ...
  },
  {
    ...
    description: "No crashes or jitters. The protocol provides steady, clean energy throughout your day without the afternoon slump.",
  ...
  },
  {
    ...
    description: "Enhanced neurotransmitter production supports deep focus states and reduces mental fatigue during demanding tasks.",
  ...
  },
  {
    ...
    description: "Better cognitive recovery overnight means you wake up sharp and ready. The protocol supports your natural recovery cycles.",
  ...
  },
  {
    ...
    description: "The structured protocol removes guesswork and builds habits that compound over time for reliable cognitive support.",
...
export default function ProtocolStruggleMobile({ protocolId }: ProtocolStruggleMobileProps) {
  ...
  return (
    <section className="px-4 pt-6 pb-8">
      ...
      <div className="mb-5 text-center">
        ...
        <p className="font-commentary text-base opacity-70">see how {protocol.name} helps</p>
      </div>
        ...
        <div className="neo-box overflow-hidden animate-slide-up">
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="border-t border-current/10 pt-4">
              <p className="font-clinical text-xs uppercase opacity-50 mb-2">{protocol.name} Benefits</p>
