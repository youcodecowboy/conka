  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      if (variantData?.variantId) {
        ...
        console.warn("Variant ID not configured for Balance Protocol starter trial pack");
      }
    } catch (error) {
      ...
      <div className="premium-track">
        ...
        <div className="mb-6 md:mb-8 text-center">
          ...
          <p className="premium-section-subtitle">
            Try the full system first — 2 Flow + 2 Clear shots in one trial pack.
          </p>
        </div>
          ...
          <div className="w-full max-w-[600px] md:hidden flex flex-col">
            ...
            <div className="premium-card-soft premium-card-soft-stroke">
              ...
              <p className="premium-body-sm text-[var(--text-on-light-muted)] mb-4">
                2 Flow + 2 Clear shots. One of everything — morning energy and evening recovery in a single pack. The best way to start.
              </p>
              ...
              <div className="mb-4">
                ...
                <p className="premium-body-sm text-[var(--text-on-light-muted)]">
                  One-time purchase · Subscribe & save 20% from your second order
                </p>
              </div>
