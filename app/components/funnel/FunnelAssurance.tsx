...
export default function FunnelAssurance() {
  return (
    <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1.5 py-3 text-xs text-black/50 tracking-wide">
      <span className="flex items-center gap-1.5">
        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="opacity-60">
          <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
          <polyline points="9 12 11 14 15 10" />
        </svg>
        <span className="font-semibold">{GUARANTEE_LABEL}</span>
      </span>
