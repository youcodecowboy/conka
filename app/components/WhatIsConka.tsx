...
const formulas: FormulaOverview[] = [
  {
    ...
    description: "Your daily foundation. Adaptogenic herbs that build stress resilience, support recovery, and provide sustained energy without caffeine crashes.",
    positioning: "ENERGY",
  ...
  },
  {
    ...
    description: "Your competitive edge. Nootropic compounds that enhance mental clarity, reaction time, and decision-making when you need peak performance.",
    positioning: "CLARITY",
...
function FormulaCard({ formula, isActive, isMobile = false }: { formula: FormulaOverview; isActive?: boolean; isMobile?: boolean }) {
  return (
    <div 
    ...
    >
      ...
      {/* Product Image */}
      <Link href={formula.link} className="block relative w-full h-40 lg:h-48 rounded-lg overflow-hidden mb-4 hover:opacity-90 transition-opacity">
        <Image
          src={formula.image}
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="font-clinical text-xs opacity-60">{formula.whenToTake}</span>
      </div>
    ...
    <section className="py-12 overflow-hidden">
      ...
      <div className="px-6 mb-6">
        ...
        <p className="font-clinical text-sm opacity-70 max-w-md">
          ...
          Every ingredient backed by peer-reviewed research. Every claim verified by PubMed.
        </p>
      </div>
        ...
        <div className="flex gap-2">
          {formulas.map((formula, idx) => (
            <button
              ...
              style={{
                borderColor: activeIndex === idx ? formula.accentColor : 'var(--foreground)',
                opacity: activeIndex === idx ? 1 : 0.4,
                backgroundColor: activeIndex === idx ? formula.accentColor : 'transparent',
      ...
      >
        {formulas.map((formula, idx) => (
          ...
          >
            <FormulaCard formula={formula} isActive={activeIndex === idx} isMobile={true} />
          </div>
        ))}
      ...
      <div className="flex justify-center gap-2 mt-6">
        {formulas.map((formula, idx) => (
          <button
            ...
            style={{
              backgroundColor: activeIndex === idx ? formula.accentColor : 'var(--foreground)',
    ...
    <section className="px-16 pt-16 pb-12">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold mb-4">What is Conka?</h2>
          <p className="font-clinical text-base opacity-70 max-w-2xl mx-auto leading-relaxed">
            ...
            One complete cognitive system. Every ingredient backed by peer-reviewed research, 
            every claim verified by studies indexed in PubMed.
          </p>
        </div>
        ...
        <div className="text-center mt-8">
          <p className="font-clinical text-sm opacity-50">
            32 peer-reviewed studies • 6,000+ clinical trial participants • 16 active ingredients
          </p>
        </div>
      </div>
    </section>
