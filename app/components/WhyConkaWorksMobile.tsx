  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-3">
        {/* Pillar 1 */}
        <div className="brand-card-bordered bg-[#e8ecf8] border-t-4 border-t-[#3a9f7e] flex flex-col items-center">
        ...
        {/* Pillar 2 */}
        <div className="brand-card-bordered bg-[#e8ecf8] flex flex-col items-center">
