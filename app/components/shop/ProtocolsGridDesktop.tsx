          ...
          >
            {protocols.map((protocol) => (
              <button
                ...
                className="neo-box p-6 hover:shadow-[8px_8px_0px_0px_var(--foreground)] transition-all duration-200 group text-left cursor-pointer"
              >
                {/* Header */}
                <div className="flex items-start gap-4 mb-4">
                  <div className="p-3 border-2 border-current rounded-lg group-hover:bg-[var(--foreground)] group-hover:text-[var(--background)] transition-colors flex-shrink-0">
                    {protocol.icon}
                  </div>
                  <div className="flex-1 min-w-0">
                    {protocol.isUltimate && (
                      <span className="px-2 py-0.5 bg-amber-500 text-white text-xs font-clinical rounded-full inline-block mb-1">
                        PREMIUM
                      </span>
                    )}
              ...
              <div className="neo-box p-8 h-full relative">
                ...
                <div className="max-w-3xl mx-auto">
                  ...
                  <div className="flex items-start gap-6 mb-6">
                    <div className="p-4 border-2 border-current rounded-lg flex-shrink-0">
                  ...
                  {/* Footer */}
                  <div className="flex items-center justify-between pt-6 border-t-2 border-current border-opacity-10">
