          ...
          {protocols.map((protocol) => {
            ...
            return (
              ...
              >
                ...
                >
                  {/* Icon */}
                  <div className="p-2 border-2 border-current rounded-lg flex-shrink-0">
                    <div className="w-6 h-6">{protocol.icon}</div>
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      {protocol.isUltimate && (
                        <span className="px-2 py-0.5 bg-amber-500 text-white text-[10px] font-clinical rounded-full">
                          PREMIUM
                        </span>
                      )}
                    </div>
