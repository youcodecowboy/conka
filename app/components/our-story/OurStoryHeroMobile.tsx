  ...
  return (
    <div className="flex flex-col gap-4">
      <header>
        ...
        <h1
          className="brand-h1-bold text-4xl font-bold tracking-tight mb-1 text-[var(--brand-black)]"
        ...
        <p className="brand-bodytext-base opacity-60" style={{ maxWidth: "var(--brand-body-max-width)" }}>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="grid grid-cols-2 gap-2">
            ...
            >
              ...
              <div className="brand-caption text-white/70">Research</div>
            </div>
            <div
              className="p-3 text-white shadow-md"
              style={{
            ...
            >
              ...
              <div className="brand-caption text-white/70">Clinical trials</div>
            </div>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <span className="brand-caption opacity-50">speed</span>
          </div>
          <div className="flex items-center gap-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="brand-caption opacity-50">women</span>
          </div>
          <div className="flex items-center gap-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="brand-caption opacity-50">years*</span>
          </div>
        </div>
      </div>

      <div className="pt-3 border-t border-[var(--brand-accent)]/30">
        <p className="brand-caption uppercase tracking-widest opacity-40 mb-2">
        ...
        <div className="space-y-1.5">
            <div className="flex items-start gap-2">
              ...
              <p className="brand-caption opacity-60">
