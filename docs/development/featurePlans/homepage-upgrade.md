...
| SCRUM-887 | 3.3 | Balance-only ProductGrid + protocol PDP selector removal — _In Review_ |
| SCRUM-888 | 3.4 | Homepage component style alignment (KeyBenefits, WhyConkaWorks, WhatToExpect, Founders, FAQ) — _In Review_ |
